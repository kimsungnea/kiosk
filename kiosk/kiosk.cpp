...
// kiosk.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CkioskApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CkioskApp::OnAppAbout)
...
CkioskApp::CkioskApp() noexcept
{
	...
	SetAppID(_T("kiosk.AppID.NoVersion"));
...
BOOL CkioskApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CkioskDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CkioskView));
	if (!pDocTemplate)
		return FALSE;
